...
class DataManager:
    def __init__(self):
        ...
        self.stances = []  # Add this line
        self.load_knights()
        self.load_all_equipment()
        self.load_stances()  # Add this line
    ...
    def save_knight_to_file(self, knight_id, knight):
        ...
        # Add combat stats to the saved data
        knight_data['combat_stats'] = knight.calculate_combat_stats()
    ...
    def load_stances(self):
        try:
            with open('I:/KH_Py/KHGame/MAIN/FIGHT_SEQ/data/stances.json', 'r') as f:
                self.stances = json.load(f)
        except Exception as e:
            print(f"Error loading stances: {e}")
            self.stances = []
